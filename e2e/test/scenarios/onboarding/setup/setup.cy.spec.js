...
describe("scenarios > setup", () => {
  locales.forEach(locale => {
    ...
    it(`should allow you to sign up using "${locale}" browser locale`, () => {
      ...
      cy.findByText("Welcome to Dashboard");
      ...
      cy.findByLabelText("Display name").type("Dashboard H2");
      // eslint-disable-next-line no-unscoped-text-selectors -- deprecated usage
      ...
      cy.findByLabelText(
        "Allow Dashboard to anonymously collect usage events",
      ).click();
      // eslint-disable-next-line no-unscoped-text-selectors -- deprecated usage
      ...
      // eslint-disable-next-line no-unscoped-text-selectors -- deprecated usage
      cy.findByText("Take me to Dashboard").click();
      cy.location("pathname").should("eq", "/");
    });
  });

  it("should set up Dashboard without first name and last name (metabase#22754)", () => {

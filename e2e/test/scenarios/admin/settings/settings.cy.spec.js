...
describe("scenarios > admin > settings", () => {
  ...
  it(
    ...
    () => {
      ...
      // eslint-disable-next-line no-unscoped-text-selectors -- deprecated usage
      cy.findByText("Migrate to Dashboard Cloud.");
  ...
  it.skip("should hide self-hosted settings when running Dashboard Cloud", () => {
    setupMetabaseCloud();
    cy.visit("/admin/settings/general");
  ...
  // Unskip when mocking Cloud in Cypress is fixed (#18289)
  it.skip("should hide the store link when running Dashboard Cloud", () => {
    setupMetabaseCloud();
    cy.visit("/admin/settings/general");

    // eslint-disable-next-line no-unscoped-text-selectors -- deprecated usage
    cy.findByText("Dashboard Admin");
  ...
  describe(" > slack settings", () => {
    it("should present the form and display errors", () => {
      ...
      // eslint-disable-next-line no-unscoped-text-selectors -- deprecated usage
      cy.findByText("Dashboard on Slack");
...
describe("scenarios > admin > settings (OSS)", { tags: "@OSS" }, () => {
  ...
  it("should show the store link when running Dashboard OSS", () => {
    cy.visit("/admin/settings/general");
...
describeEE("scenarios > admin > settings (EE)", () => {
  ...
  // Unskip when mocking Cloud in Cypress is fixed (#18289)
  it.skip("should hide Enterprise page when running Dashboard Cloud", () => {
    setupMetabaseCloud();
    cy.visit("/admin/settings/general");
  ...
  it("should hide the store link when running Dashboard EE", () => {
    cy.visit("/admin/settings/general");

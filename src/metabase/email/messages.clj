...
(defn- app-name-trs
  "Return the user configured application name, or Dashboard translated
...
(defn send-new-user-email!
  "Send an email to `invitied` letting them know `invitor` has invited them to join Dashboard."
...
(defn send-follow-up-email!
  ...
  (let [context (merge (common-context)
                       {:emailType    "notification"
                        :logoHeader   true
                        :heading      (trs "We hope you''ve been enjoying Dashboard.")

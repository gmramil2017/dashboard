(ns metabase.models.permissions
  "Low-level Dashboard permissions system definition and utility functions.

  The Dashboard permissions system is based around permissions *paths* that are granted to individual
  ...
  * *block \"anti-permissions\"* are per-Group, per-Table grants that tell Dashboard to disallow running Saved

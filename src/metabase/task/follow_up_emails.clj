(ns metabase.task.follow-up-emails
  "Tasks which follow up with Dashboard users."
  (:require
...
(defn- send-follow-up-email!
  "Send an email to the instance admin following up on their experience with Dashboard thus far."
  []
...
(defn- instance-creation-timestamp
  "The date this Dashboard instance was created. We use the `:date_joined` of the first `User` to determine this."

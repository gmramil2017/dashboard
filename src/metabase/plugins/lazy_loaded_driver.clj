(ns metabase.plugins.lazy-loaded-driver
  ...
  See https://github.com/metabase/metabase/wiki/Dashboard-Plugin-Manifest-Reference for all the options allowed for a
  plugin manifest."
  (:require
...
(defn register-lazy-loaded-driver!
  "Register a basic shell of a Dashboard driver using the information from its Dashboard plugin"
  ...
  (let [driver           (keyword driver-name)
    ...
    ;; finally, register the Dashboard driver

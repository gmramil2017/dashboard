...
(def DatabaseInstance "Schema for a valid instance of a Dashboard Database." (mi/InstanceOf Database))
(def TableInstance    "Schema for a valid instance of a Dashboard Table."    (mi/InstanceOf Table))
(def FieldInstance    "Schema for a valid instance of a Dashboard Field."    (mi/InstanceOf Field))

...
(def TableMetadataFieldWithID
  "Schema for `TableMetadataField` with an included ID of the corresponding Dashboard Field object.
...
(s/defn matching-field-metadata :- (s/maybe TableMetadataFieldWithOptionalID)
  ...
  corresponding Dashboard Field for field metadata from the DB, or vice versa."

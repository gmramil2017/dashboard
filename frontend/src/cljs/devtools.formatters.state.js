...
var len__5769__auto___30314 = arguments.length;
var i__5770__auto___30315 = (0);
while(true){
if((i__5770__auto___30315 < len__5769__auto___30314)){
args__5775__auto__.push((arguments[i__5770__auto___30315]));

var G__30316 = (i__5770__auto___30315 + (1));
i__5770__auto___30315 = G__30316;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq30198){
var G__30199 = cljs.core.first(seq30198);
var seq30198__$1 = cljs.core.next(seq30198);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30199,seq30198__$1);
}));
...
return cljs.core.some((function (p1__30206_SHARP_){
return (p1__30206_SHARP_ === object);
}),history__$1);
});
...
var args__5775__auto__ = [];
var len__5769__auto___30321 = arguments.length;
var i__5770__auto___30322 = (0);
while(true){
if((i__5770__auto___30322 < len__5769__auto___30321)){
args__5775__auto__.push((arguments[i__5770__auto___30322]));

var G__30323 = (i__5770__auto___30322 + (1));
i__5770__auto___30322 = G__30323;
continue;
} else {
}
break;
...
(devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (v,p__30219){
var vec__30220 = p__30219;
var starting_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30220,(0),null);
if(typeof v === 'string'){
return v;
} else {
...
/** @this {Function} */
(devtools.formatters.state.present_path_segment.cljs$lang$applyTo = (function (seq30213){
var G__30214 = cljs.core.first(seq30213);
var seq30213__$1 = cljs.core.next(seq30213);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30214,seq30213__$1);
}));
...
var G__30327 = (i__5770__auto___30326 + (1));
i__5770__auto___30326 = G__30327;
continue;
} else {
}
break;
...
(devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (coll,val,p__30237){
var vec__30238 = p__30237;
var seq_SINGLEQUOTE_d_map_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30238,(0),null);
...
/** @this {Function} */
(devtools.formatters.state.seek_path_segment.cljs$lang$applyTo = (function (seq30231){
var G__30232 = cljs.core.first(seq30231);
var seq30231__$1 = cljs.core.next(seq30231);
var G__30233 = cljs.core.first(seq30231__$1);
var seq30231__$2 = cljs.core.next(seq30231__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30232,G__30233,seq30231__$2);
}));
...
Object.defineProperty(module.exports, "prevent_recursion_QMARK_", { enumerable: false, get: function() { return devtools.formatters.state.prevent_recursion_QMARK_; } });
Object.defineProperty(module.exports, "add_object_to_current_path_info_BANG_", { enumerable: false, get: function() { return devtools.formatters.state.add_object_to_current_path_info_BANG_; } });
Object.defineProperty(module.exports, "find_path_in_fake_vector", { enumerable: false, get: function() { return devtools.formatters.state.find_path_in_fake_vector; } });
Object.defineProperty(module.exports, "get_managed_print_level", { enumerable: false, get: function() { return devtools.formatters.state.get_managed_print_level; } });
Object.defineProperty(module.exports, "get_current_state", { enumerable: false, get: function() { return devtools.formatters.state.get_current_state; } });
Object.defineProperty(module.exports, "get_current_history", { enumerable: false, get: function() { return devtools.formatters.state.get_current_history; } });
Object.defineProperty(module.exports, "mapping_QMARK_", { enumerable: false, get: function() { return devtools.formatters.state.mapping_QMARK_; } });
Object.defineProperty(module.exports, "ignore_path_in_fake_vector", { enumerable: false, get: function() { return devtools.formatters.state.ignore_path_in_fake_vector; } });
Object.defineProperty(module.exports, "set_managed_print_level", { enumerable: false, get: function() { return devtools.formatters.state.set_managed_print_level; } });
Object.defineProperty(module.exports, "extend_path_info", { enumerable: false, get: function() { return devtools.formatters.state.extend_path_info; } });
Object.defineProperty(module.exports, "push_object_to_current_history_BANG_", { enumerable: false, get: function() { return devtools.formatters.state.push_object_to_current_history_BANG_; } });
Object.defineProperty(module.exports, "update_current_state_BANG_", { enumerable: false, get: function() { return devtools.formatters.state.update_current_state_BANG_; } });
Object.defineProperty(module.exports, "get_depth_budget", { enumerable: false, get: function() { return devtools.formatters.state.get_depth_budget; } });
Object.defineProperty(module.exports, "build_path_segment", { enumerable: false, get: function() { return devtools.formatters.state.build_path_segment; } });
Object.defineProperty(module.exports, "_STAR_current_state_STAR_", { enumerable: false, get: function() { return devtools.formatters.state._STAR_current_state_STAR_; } });
Object.defineProperty(module.exports, "seek_path_segment", { enumerable: false, get: function() { return devtools.formatters.state.seek_path_segment; } });
Object.defineProperty(module.exports, "get_current_path_info", { enumerable: false, get: function() { return devtools.formatters.state.get_current_path_info; } });
Object.defineProperty(module.exports, "get_default_state", { enumerable: false, get: function() { return devtools.formatters.state.get_default_state; } });
Object.defineProperty(module.exports, "get_second_last_object_from_current_history", { enumerable: false, get: function() { return devtools.formatters.state.get_second_last_object_from_current_history; } });
Object.defineProperty(module.exports, "valid_current_state_QMARK_", { enumerable: false, get: function() { return devtools.formatters.state.valid_current_state_QMARK_; } });
Object.defineProperty(module.exports, "reset_depth_limits", { enumerable: false, get: function() { return devtools.formatters.state.reset_depth_limits; } });
Object.defineProperty(module.exports, "set_prevent_recursion", { enumerable: false, get: function() { return devtools.formatters.state.set_prevent_recursion; } });
Object.defineProperty(module.exports, "get_last_object_from_current_history", { enumerable: false, get: function() { return devtools.formatters.state.get_last_object_from_current_history; } });
Object.defineProperty(module.exports, "find_path", { enumerable: false, get: function() { return devtools.formatters.state.find_path; } });
Object.defineProperty(module.exports, "present_path_segment", { enumerable: false, get: function() { return devtools.formatters.state.present_path_segment; } });
Object.defineProperty(module.exports, "set_depth_budget", { enumerable: false, get: function() { return devtools.formatters.state.set_depth_budget; } });
Object.defineProperty(module.exports, "is_circular_QMARK_", { enumerable: false, get: function() { return devtools.formatters.state.is_circular_QMARK_; } });

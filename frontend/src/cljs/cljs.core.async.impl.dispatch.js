...
var count_34727 = (0);
while(true){
var m_34728 = cljs.core.async.impl.dispatch.tasks.pop();
if((m_34728 == null)){
} else {
(m_34728.cljs$core$IFn$_invoke$arity$0 ? m_34728.cljs$core$IFn$_invoke$arity$0() : m_34728.call(null));

if((count_34727 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE)){
var G__34730 = (count_34727 + (1));
count_34727 = G__34730;
continue;
} else {
}
}

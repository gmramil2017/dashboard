...
var len__5769__auto___30701 = arguments.length;
var i__5770__auto___30702 = (0);
while(true){
if((i__5770__auto___30702 < len__5769__auto___30701)){
args__5775__auto__.push((arguments[i__5770__auto___30702]));

var G__30703 = (i__5770__auto___30702 + (1));
i__5770__auto___30702 = G__30703;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30566){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30567,G__30568,seq30566__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30639_SHARP_){
return (!((cljs.core.meta(p1__30639_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30672__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30673){var _e__29675__auto__ = e30673;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e30675){var _e__29675__auto__ = e30675;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__30679 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30680 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30680);
...
var map__30682 = opts;
var map__30682__$1 = cljs.core.__destructure_map(map__30682);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30682__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30679);
}});
...
var temp__5802__auto___30711 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___30711)){
var managed_print_level_30712 = temp__5802__auto___30711;
var _STAR_print_level_STAR__orig_val__30688_30713 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30689_30714 = managed_print_level_30712;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30689_30714);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__30686_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__30686_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30688_30713);
}} else {
job_fn();
}
...
Object.defineProperty(module.exports, "__GT_TemplateWriter", { enumerable: false, get: function() { return devtools.formatters.printing.__GT_TemplateWriter; } });
Object.defineProperty(module.exports, "alt_printer_impl", { enumerable: false, get: function() { return devtools.formatters.printing.alt_printer_impl; } });
Object.defineProperty(module.exports, "markup_QMARK_", { enumerable: false, get: function() { return devtools.formatters.printing.markup_QMARK_; } });
Object.defineProperty(module.exports, "wrap_group_in_meta_if_needed", { enumerable: false, get: function() { return devtools.formatters.printing.wrap_group_in_meta_if_needed; } });
Object.defineProperty(module.exports, "mark_as_markup", { enumerable: false, get: function() { return devtools.formatters.printing.mark_as_markup; } });
Object.defineProperty(module.exports, "detect_edge_case_and_patch_it", { enumerable: false, get: function() { return devtools.formatters.printing.detect_edge_case_and_patch_it; } });
Object.defineProperty(module.exports, "wrap_group_in_reference_if_needed", { enumerable: false, get: function() { return devtools.formatters.printing.wrap_group_in_reference_if_needed; } });
Object.defineProperty(module.exports, "managed_print_via_writer", { enumerable: false, get: function() { return devtools.formatters.printing.managed_print_via_writer; } });
Object.defineProperty(module.exports, "already_reference_QMARK_", { enumerable: false, get: function() { return devtools.formatters.printing.already_reference_QMARK_; } });
Object.defineProperty(module.exports, "TemplateWriter", { enumerable: false, get: function() { return devtools.formatters.printing.TemplateWriter; } });
Object.defineProperty(module.exports, "wrap_value_as_reference_if_needed", { enumerable: false, get: function() { return devtools.formatters.printing.wrap_value_as_reference_if_needed; } });
Object.defineProperty(module.exports, "managed_print_via_protocol", { enumerable: false, get: function() { return devtools.formatters.printing.managed_print_via_protocol; } });
Object.defineProperty(module.exports, "alt_printer_job", { enumerable: false, get: function() { return devtools.formatters.printing.alt_printer_job; } });
Object.defineProperty(module.exports, "make_template_writer", { enumerable: false, get: function() { return devtools.formatters.printing.make_template_writer; } });
Object.defineProperty(module.exports, "wrap_group_in_circular_warning_if_needed", { enumerable: false, get: function() { return devtools.formatters.printing.wrap_group_in_circular_warning_if_needed; } });
Object.defineProperty(module.exports, "managed_print", { enumerable: false, get: function() { return devtools.formatters.printing.managed_print; } });
Object.defineProperty(module.exports, "build_markup", { enumerable: false, get: function() { return devtools.formatters.printing.build_markup; } });
Object.defineProperty(module.exports, "post_process_printed_output", { enumerable: false, get: function() { return devtools.formatters.printing.post_process_printed_output; } });
Object.defineProperty(module.exports, "wrap_group_with_path_annotation", { enumerable: false, get: function() { return devtools.formatters.printing.wrap_group_with_path_annotation; } });

...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k59636,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k59636,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__59641){
var vec__59642 = p__59641;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59642,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59642,(1),null);
...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__59635){
var self__ = this;
var G__59635__$1 = this;
return (new cljs.core.RecordIter((0),G__59635__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this59637,other59638){
var self__ = this;
var this59637__$1 = this;
return (((!((other59638 == null)))) && ((((this59637__$1.constructor === other59638.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59637__$1.pre,other59638.pre)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59637__$1.__extmap,other59638.__extmap)))))));
}));
...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k59636){
var self__ = this;
var this__5350__auto____$1 = this;
var G__59664 = k59636;
var G__59664__$1 = (((G__59664 instanceof cljs.core.Keyword))?G__59664.fqn:null);
switch (G__59664__$1) {
case "pre":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k59636);

}
}));

(schema.spec.leaf.LeafSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__59635){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__59665 = cljs.core.keyword_identical_QMARK_;
var expr__59666 = k__5352__auto__;
if(cljs.core.truth_((pred__59665.cljs$core$IFn$_invoke$arity$2 ? pred__59665.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pre","pre",2118456869),expr__59666) : pred__59665.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__59666)))){
return (new schema.spec.leaf.LeafSpec(G__59635,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.leaf.LeafSpec(self__.pre,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__59635),null));
}
}));
...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__59635){
var self__ = this;
var this__5342__auto____$1 = this;
return (new schema.spec.leaf.LeafSpec(self__.pre,G__59635,self__.__extmap,self__.__hash));
}));
 ...
 */
schema.spec.leaf.map__GT_LeafSpec = (function schema$spec$leaf$map__GT_LeafSpec(G__59639){
var extmap__5385__auto__ = (function (){var G__59686 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__59639,new cljs.core.Keyword(null,"pre","pre",2118456869));
if(cljs.core.record_QMARK_(G__59639)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__59686);
} else {
return G__59686;
}
})();
return (new schema.spec.leaf.LeafSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__59639),null,cljs.core.not_empty(extmap__5385__auto__),null));
});

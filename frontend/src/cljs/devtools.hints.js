...
var map__30036 = top_item;
var map__30036__$1 = cljs.core.__destructure_map(map__30036);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30036__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30036__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30036__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e30035){var _e = e30035;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___30075 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___30075)){
var seen_errors_30076 = temp__5802__auto___30075;
if(cljs.core.truth_(seen_errors_30076.has(self))){
} else {
seen_errors_30076.add(self);

var temp__5804__auto___30078 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___30078)){
var sense_30080 = temp__5804__auto___30078;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_30080)].join(''));
} else {
}
}
} else {
...
Object.defineProperty(module.exports, "mark_null_call_site_location", { enumerable: false, get: function() { return devtools.hints.mark_null_call_site_location; } });
Object.defineProperty(module.exports, "mark_call_closed_at_column", { enumerable: false, get: function() { return devtools.hints.mark_call_closed_at_column; } });
Object.defineProperty(module.exports, "set_processed_errors_BANG_", { enumerable: false, get: function() { return devtools.hints.set_processed_errors_BANG_; } });
Object.defineProperty(module.exports, "error_object_sense", { enumerable: false, get: function() { return devtools.hints.error_object_sense; } });
Object.defineProperty(module.exports, "_STAR_original_global_error_handler_STAR_", { enumerable: false, get: function() { return devtools.hints._STAR_original_global_error_handler_STAR_; } });
Object.defineProperty(module.exports, "_STAR_installed_STAR_", { enumerable: false, get: function() { return devtools.hints._STAR_installed_STAR_; } });
Object.defineProperty(module.exports, "_STAR_original_type_error_prototype_to_string_STAR_", { enumerable: false, get: function() { return devtools.hints._STAR_original_type_error_prototype_to_string_STAR_; } });
Object.defineProperty(module.exports, "processed_errors", { enumerable: false, get: function() { return devtools.hints.processed_errors; } });
Object.defineProperty(module.exports, "global_error_handler", { enumerable: false, get: function() { return devtools.hints.global_error_handler; } });
Object.defineProperty(module.exports, "install_BANG_", { enumerable: false, get: function() { return devtools.hints.install_BANG_; } });
Object.defineProperty(module.exports, "ajax_reader", { enumerable: false, get: function() { return devtools.hints.ajax_reader; } });
Object.defineProperty(module.exports, "get_line", { enumerable: false, get: function() { return devtools.hints.get_line; } });
Object.defineProperty(module.exports, "extend_content", { enumerable: false, get: function() { return devtools.hints.extend_content; } });
Object.defineProperty(module.exports, "retrieve_javascript_source", { enumerable: false, get: function() { return devtools.hints.retrieve_javascript_source; } });
Object.defineProperty(module.exports, "available_QMARK_", { enumerable: false, get: function() { return devtools.hints.available_QMARK_; } });
Object.defineProperty(module.exports, "empty_as_nil", { enumerable: false, get: function() { return devtools.hints.empty_as_nil; } });
Object.defineProperty(module.exports, "make_sense_of_the_error", { enumerable: false, get: function() { return devtools.hints.make_sense_of_the_error; } });
Object.defineProperty(module.exports, "installed_QMARK_", { enumerable: false, get: function() { return devtools.hints.installed_QMARK_; } });
Object.defineProperty(module.exports, "type_error_to_string", { enumerable: false, get: function() { return devtools.hints.type_error_to_string; } });
Object.defineProperty(module.exports, "parse_stacktrace", { enumerable: false, get: function() { return devtools.hints.parse_stacktrace; } });
Object.defineProperty(module.exports, "get_processed_errors_BANG_", { enumerable: false, get: function() { return devtools.hints.get_processed_errors_BANG_; } });
Object.defineProperty(module.exports, "uninstall_BANG_", { enumerable: false, get: function() { return devtools.hints.uninstall_BANG_; } });
Object.defineProperty(module.exports, "install_type_error_enhancer", { enumerable: false, get: function() { return devtools.hints.install_type_error_enhancer; } });

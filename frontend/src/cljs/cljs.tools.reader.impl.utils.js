...
(cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k56646,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k56646,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__56654){
var vec__56655 = p__56654;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56655,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56655,(1),null);
...
(cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__56645){
var self__ = this;
var G__56645__$1 = this;
return (new cljs.core.RecordIter((0),G__56645__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),new cljs.core.Keyword(null,"form","form",-1624062471)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this56647,other56648){
var self__ = this;
var this56647__$1 = this;
return (((!((other56648 == null)))) && ((((this56647__$1.constructor === other56648.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56647__$1.splicing_QMARK_,other56648.splicing_QMARK_)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56647__$1.form,other56648.form)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56647__$1.__extmap,other56648.__extmap)))))))));
}));
...
(cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k56646){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k56646);

}
}));

(cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__56645){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__56669 = cljs.core.keyword_identical_QMARK_;
var expr__56670 = k__5352__auto__;
if(cljs.core.truth_((pred__56669.cljs$core$IFn$_invoke$arity$2 ? pred__56669.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),expr__56670) : pred__56669.call(null,new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),expr__56670)))){
return (new cljs.tools.reader.impl.utils.ReaderConditional(G__56645,self__.form,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56669.cljs$core$IFn$_invoke$arity$2 ? pred__56669.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"form","form",-1624062471),expr__56670) : pred__56669.call(null,new cljs.core.Keyword(null,"form","form",-1624062471),expr__56670)))){
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,G__56645,self__.__meta,self__.__extmap,null));
} else {
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,self__.form,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__56645),null));
}
}
}));
...
(cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__56645){
var self__ = this;
var this__5342__auto____$1 = this;
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,self__.form,G__56645,self__.__extmap,self__.__hash));
}));
 ...
 */
cljs.tools.reader.impl.utils.map__GT_ReaderConditional = (function cljs$tools$reader$impl$utils$map__GT_ReaderConditional(G__56649){
var extmap__5385__auto__ = (function (){var G__56676 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__56649,new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"form","form",-1624062471)], 0));
if(cljs.core.record_QMARK_(G__56649)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__56676);
} else {
return G__56676;
}
})();
return (new cljs.tools.reader.impl.utils.ReaderConditional(new cljs.core.Keyword(null,"splicing?","splicing?",-428596366).cljs$core$IFn$_invoke$arity$1(G__56649),new cljs.core.Keyword(null,"form","form",-1624062471).cljs$core$IFn$_invoke$arity$1(G__56649),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var iter__5523__auto__ = (function cljs$tools$reader$impl$utils$namespace_keys_$_iter__56682(s__56683){
return (new cljs.core.LazySeq(null,(function (){
var s__56683__$1 = s__56683;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__56683__$1);
if(temp__5804__auto__){
var s__56683__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56683__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__56683__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__56685 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__56684 = (0);
while(true){
if((i__56684 < size__5522__auto__)){
var key = cljs.core._nth(c__5521__auto__,i__56684);
cljs.core.chunk_append(b__56685,(((((key instanceof cljs.core.Symbol)) || ((key instanceof cljs.core.Keyword))))?(function (){var vec__56688 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace,cljs.core.name)(key);
var key_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56688,(0),null);
var key_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56688,(1),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56685),cljs$tools$reader$impl$utils$namespace_keys_$_iter__56682(cljs.core.chunk_rest(s__56683__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56685),null);
}
} else {
var key = cljs.core.first(s__56683__$2);
return cljs.core.cons((((((key instanceof cljs.core.Symbol)) || ((key instanceof cljs.core.Keyword))))?(function (){var vec__56691 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace,cljs.core.name)(key);
var key_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56691,(0),null);
var key_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56691,(1),null);
var __GT_key = (((key instanceof cljs.core.Symbol))?cljs.core.symbol:cljs.core.keyword);
if((key_ns == null)){
return (__GT_key.cljs$core$IFn$_invoke$arity$2 ? __GT_key.cljs$core$IFn$_invoke$arity$2(ns,key_name) : __GT_key.call(null,ns,key_name));
} else {
...
})():key),cljs$tools$reader$impl$utils$namespace_keys_$_iter__56682(cljs.core.rest(s__56683__$2)));
}
} else {
return null;
}
...
cljs.tools.reader.impl.utils.second_SINGLEQUOTE_ = (function cljs$tools$reader$impl$utils$second_SINGLEQUOTE_(p__56696){
var vec__56697 = p__56696;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56697,(0),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56697,(1),null);

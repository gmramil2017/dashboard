...
}catch (e59645){if((e59645 instanceof Object)){
var e_SHARP_ = e59645;
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k59647,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__59657 = k59647;
var G__59657__$1 = (((G__59657 instanceof cljs.core.Keyword))?G__59657.fqn:null);
switch (G__59657__$1) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k59647,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__59660){
var vec__59661 = p__59660;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59661,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59661,(1),null);
...
var G__59668 = schema.utils.value_name(x);
return (self__.err_f.cljs$core$IFn$_invoke$arity$1 ? self__.err_f.cljs$core$IFn$_invoke$arity$1(G__59668) : self__.err_f.call(null,G__59668));
}),null)),null));
...
var or__5045__auto____$1 = (function (){var G__59673 = (cljs.core.truth_(new cljs.core.Keyword(null,"return-walked?","return-walked?",-1684646015).cljs$core$IFn$_invoke$arity$1(params))?v:x);
return (self__.post.cljs$core$IFn$_invoke$arity$1 ? self__.post.cljs$core$IFn$_invoke$arity$1(G__59673) : self__.post.call(null,G__59673));
})();
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this59648,other59649){
var self__ = this;
var this59648__$1 = this;
return (((!((other59649 == null)))) && ((((this59648__$1.constructor === other59649.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59648__$1.pre,other59649.pre)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59648__$1.options,other59649.options)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59648__$1.err_f,other59649.err_f)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59648__$1.post,other59649.post)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59648__$1.__extmap,other59649.__extmap)))))))))))));
}));
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k59647){
var self__ = this;
var this__5350__auto____$1 = this;
var G__59764 = k59647;
var G__59764__$1 = (((G__59764 instanceof cljs.core.Keyword))?G__59764.fqn:null);
switch (G__59764__$1) {
case "pre":
case "options":
case "err-f":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k59647);

}
}));

(schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__59646){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__59766 = cljs.core.keyword_identical_QMARK_;
var expr__59767 = k__5352__auto__;
if(cljs.core.truth_((pred__59766.cljs$core$IFn$_invoke$arity$2 ? pred__59766.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pre","pre",2118456869),expr__59767) : pred__59766.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__59767)))){
return (new schema.spec.variant.VariantSpec(G__59646,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__59766.cljs$core$IFn$_invoke$arity$2 ? pred__59766.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"options","options",99638489),expr__59767) : pred__59766.call(null,new cljs.core.Keyword(null,"options","options",99638489),expr__59767)))){
return (new schema.spec.variant.VariantSpec(self__.pre,G__59646,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__59766.cljs$core$IFn$_invoke$arity$2 ? pred__59766.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__59767) : pred__59766.call(null,new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__59767)))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__59646,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__59766.cljs$core$IFn$_invoke$arity$2 ? pred__59766.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"post","post",269697687),expr__59767) : pred__59766.call(null,new cljs.core.Keyword(null,"post","post",269697687),expr__59767)))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__59646,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__59646),null));
}
}
}
}
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__59646){
var self__ = this;
var this__5342__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__59646,self__.__extmap,self__.__hash));
}));
 ...
 */
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__59652){
var extmap__5385__auto__ = (function (){var G__59770 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__59652,new cljs.core.Keyword(null,"pre","pre",2118456869),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941),new cljs.core.Keyword(null,"post","post",269697687)], 0));
if(cljs.core.record_QMARK_(G__59652)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__59770);
} else {
return G__59770;
}
})();
return (new schema.spec.variant.VariantSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__59652),new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(G__59652),new cljs.core.Keyword(null,"err-f","err-f",651620941).cljs$core$IFn$_invoke$arity$1(G__59652),new cljs.core.Keyword(null,"post","post",269697687).cljs$core$IFn$_invoke$arity$1(G__59652),null,cljs.core.not_empty(extmap__5385__auto__),null));
});

  ...
  return (
    <MetadataSection>
      <MetadataSectionHeader
        title={t`Visibility`}
        description={t`Where this field will appear throughout Dashboard`}
      />
  ...
  return (
    <MetadataSection last>
      <MetadataSectionHeader
        ...
        description={t`Dashboard can scan the values for this field to enable checkbox filters in dashboards and questions.`}
      />
      <ActionButton

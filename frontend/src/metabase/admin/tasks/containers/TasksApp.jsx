      ...
      <SectionRoot>
        <SectionHeader>
          <SectionTitle>
            ...
            <Tooltip
              tooltip={t`Trying to get to the bottom of something? This section shows logs of Dashboard's background tasks, which can help shed light on what's going on.`}
            >
              <Icon
                name="info"
                style={{ marginTop: 5 }}

...
const SECTIONS = {
  ...
  email: {
    ...
    settings: [
      ...
      },
      {
        ...
        placeholder: "Dashboard-replies@yourcompany.com",
        type: "string",
        required: false,
    ...
    settings: [
      {
        ...
        note: t`Dashboard uses OpenStreetMaps by default.`,
        type: "string",
      },
      {
        key: "custom-geojson",
  ...
  //       embedDescription: t`With this Pro/Enterprise feature you can embed the full Dashboard app. Enable your users to drill-through to charts, browse collections, and use the graphical query builder.`,
  //       embedType: "full-app",
  //     },
  //   ],
  // },
  ...
  caching: {
    ...
    settings: [
      ...
      },
      {
        ...
        description: jt`Enabling cache will create tables for your models in a dedicated schema and Dashboard will refresh them on a schedule. Questions based on your models will query these tables. ${(
          <ExternalLink

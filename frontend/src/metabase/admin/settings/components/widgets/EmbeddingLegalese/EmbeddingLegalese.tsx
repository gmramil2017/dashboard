...
const EmbeddingLegalese = ({ setting, onChange }: EmbeddingLegaleseProps) => (
  <div className="text-measure">
    ...
    <Paragraph>
      {t`Embed dashboards, questions, or the entire Dashboard app into your application. Integrate with your server code to create a secure environment, limited to specific users or organizations.`}
    </Paragraph>
    ...
    >
      <Paragraph>
        {t`When you embed charts or dashboards from Dashboard in your own
        application, that application isn't subject to the Affero General Public
        License that covers the rest of Dashboard, provided you keep the Dashboard
        logo and the "Powered by Dashboard" visible on those embeds.`}
      </Paragraph>
      <Paragraph>

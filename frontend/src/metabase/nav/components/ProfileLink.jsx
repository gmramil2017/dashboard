...
function ProfileLink({ user, adminItems, onLogout }) {
  ...
  const generateOptionsForUser = () => {
    ...
    return [
      ...
      //   title: t`Help`,
      //   icon: null,
      //   link: `https://www.blitzgrp.com/contact.php`,
      //   // link:
      //   //   isAdmin && isPaidPlan
  ...
  const showTrademark = t`Dashboard` === "Dashboard";
  return (
    <div>
      <EntityMenu
        tooltip={t`Settings`}
        ...
        <Modal small onClose={closeModal}>
          <div className="px4 pt4 pb2 text-centered relative">
            ...
            <h2
              ...
              className="text-dark"
            >{t`Thanks for using Dashboard!`}</h2>
            <div className="pt2">
          ...
          {/* {showTrademark && (
            ...
            >
              <span className="block">
                ...
                {t`is a Trademark of`} Dashboard, Inc
              </span>

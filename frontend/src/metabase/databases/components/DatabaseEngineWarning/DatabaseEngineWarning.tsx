...
const CommunityEngineWarning = () => (
  <Warning icon="info">
    {t`This is a community-developed driver and not supported by Dashboard. `}
  </Warning>
);
...
const PartnerEngineWarning = ({
  ...
  return (
    <Warning icon="info">
      {t`This is a partner-developed driver. Though Dashboard can’t provide support for it, if you need help you can contact the fine folks at `}
      {contactLink}

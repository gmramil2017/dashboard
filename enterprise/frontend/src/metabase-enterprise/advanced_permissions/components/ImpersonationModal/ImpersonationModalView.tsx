...
export const ImpersonationModalView = ({
  ...
  return (
    <ImpersonationModalViewRoot>
      ...
      <ImpersonationDescription>
        {t`When the person runs a query (including native queries), Dashboard will impersonate the privileges of the database role you associate with the user attribute.`}{" "}
        <ExternalLink
          className="link"

  ...
  it("should render the content", async () => {
    ...
    expect(
      await screen.findByText(
        "When the person runs a query (including native queries), Dashboard will impersonate the privileges of the database role you associate with the user attribute.",
      ),
    ).toBeInTheDocument();

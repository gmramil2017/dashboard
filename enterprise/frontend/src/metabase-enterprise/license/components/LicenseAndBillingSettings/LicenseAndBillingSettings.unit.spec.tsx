  ...
  it("renders settings for store managed billing with a valid token", async () => {
    ...
    expect(
      await screen.findByText(
        "Manage your Cloud account, including billing preferences, in your Dashboard Store account.",
      ),
    ).toBeInTheDocument();
    expect(screen.getByText("Go to the Dashboard Store")).toBeInTheDocument();

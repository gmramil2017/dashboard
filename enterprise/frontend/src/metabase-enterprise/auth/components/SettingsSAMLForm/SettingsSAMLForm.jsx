  ...
  return (
    ...
    >
      ...
      <SAMLFormSection>
        ...
        <p className="mb4 mt1 text-medium">{t`Your identity provider will need the following info about Dashboard.`}</p>
      ...
      <SAMLFormSection>
        <h3 className="mb0">{t`Tell Dashboard about your identity provider`}</h3>
        <p className="mb4 mt1 text-medium">{t`Dashboard will need the following info about your provider.`}</p>
        <FormField
      ...
      <SAMLFormSection wide>
        ...
        <p className="mb4 mt1 text-medium">
          {t`To enable this, you'll need to create mappings to tell Dashboard which group(s) your users should

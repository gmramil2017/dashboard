...
export const EmbeddingAppOriginDescription = () => {
  return (
    <div>
      {jt`With this Pro/Enterprise feature you can embed the full Dashboard app. Enable your users to drill-through to charts, browse collections, and use the graphical query builder. ${(
        <ExternalLink
          key="learn-more"

...
(defenterprise greeting
  ...
  :feature :none
  [username]
  (format "Hi %s, you're running the Enterprise Edition of Dashboard!" (name username)))
...
(defenterprise-schema greeting-with-schema :- s/Str
  ...
  :feature :none
  [username :- s/Keyword]
  (format "Hi %s, the schema was valid, and you're running the Enterprise Edition of Dashboard!" (name username)))

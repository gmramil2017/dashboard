(ns metabase-enterprise.api.routes
  "API routes that are only available when running Dashboard® Enterprise Edition™. Even tho these routes are available,
...
(compojure/defroutes ^{:doc "API routes only available when running Dashboard® Enterprise Edition™."} routes

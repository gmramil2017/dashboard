(ns metabase-enterprise.serialization.v2.extract
  "Extraction is the first step in serializing a Dashboard appdb so it can be eg. written to disk.
...
(defn- extract-metabase
  ...
  (log/tracef "Extracting Dashboard with options: %s" (pr-str opts))

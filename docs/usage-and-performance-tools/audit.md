...
As an administrator of Dashboard, you already know the importance of using data to understand your how people interact with your products or services. With the Audit tool, you can use Dashboard to understand how people in your organization use Dashboard. It's, well, meta!
...
Use the __People__ section to gain a better understanding of how people are interacting with Dashboard. You'll want to pay attention to the __Overview__ tab, especially when you first launch Dashboard at your organization — it will give you data around how many active and newly created accounts you have each day. Further down the page, you'll see charts showing you which people are most engaged.
...
Here admins can get an overview of all of the [dashboard subscriptions][dashboard-subscriptions] and [alerts][alerts] that are currently active for that Dashboard.

...
![Dashboard dashboard](./images/metabase-product-screenshot.png)

Dashboard is an open-source business intelligence platform. You can use Dashboard to ask questions about your data, or embed Dashboard in your app to let your customers explore their data on their own.

## First steps

### [Installing Dashboard](./installation-and-operation/installing-metabase.md)

Run as a JAR, using Docker, or on Dashboard Cloud.

### [Setting up Dashboard](./configuring-metabase/setting-up-metabase.md)

Once installed, set up your Dashboard and connect to your data.
...
### [A tour of Dashboard](https://www.metabase.com/learn/getting-started/tour-of-metabase)

Dashboard is a deep product with a lot of tools to simplify business intelligence, from embeddable charts and interactive dashboards, to GUI and SQL editors, to auditing and data sandboxing, and more.

## Documentation topics

Dashboard's reference documentation.
...
- [Configuring the Dashboard application database](./installation-and-operation/configuring-application-database.md)
- [Backing up Dashboard](./installation-and-operation/backing-up-metabase-application-data.md)
...
- [Monitoring your Dashboard](./installation-and-operation/monitoring-metabase.md)
...
- [Dashboard log configuration](./configuring-metabase/log-configuration.md)
...
- [Customizing the Dashboard Jetty webserver](./configuring-metabase/customizing-jetty-webserver.md)
...
- [Documentation for Dashboard Cloud and Store](https://www.metabase.com/docs/latest/cloud/start)

### Dashboard API

- [Dashboard API documentation](./api-documentation.md)
...
Some Dashboard plans offer [additional features](./paid-features/start.md).
...
- [Troubleshooting guides](troubleshooting-guide/index.md)
- [Dashboard forum](https://discourse.metabase.com/)
- [Configuring logging](./configuring-metabase/log-configuration.md)

### Tutorials and guides

[Learn Dashboard](https://www.metabase.com/learn) has a ton of articles on how to use Dashboard, data best practices, and more.
...
### [Dashboard Cloud](https://www.metabase.com/cloud/docs)

For docs specific to Dashboard Cloud plans.

### [Community stories](https://www.metabase.com/community)

Practical advice from our community.

### [Dashboard blog](https://www.metabase.com/blog)
...
### [Dashboard Twitter](https://twitter.com/metabase)
...
A list of all Dashboard releases, including both the Enterprise Edition and the Open Source Edition.

### [Developers guide](./developers-guide/start.md)

Contribute to the Dashboard open source project!

### [Data and Business Intelligence Glossary](https://www.metabase.com/glossary)

Data jargon explained.

### [Dashboard Experts](https://www.metabase.com/partners/)

...
1. Check if you're using a Dashboard version that's 0.42.0 or greater by going to the top right of the screen and clicking on the **gear** icon > **About Dashboard**.
2. Clear your browser cache.
3. Ask your Dashboard admin to clear the proxy cache (if you're using one).
4. Ask your Dashboard admin if [nested queries are enabled][nested-query-settings-docs] under **Admin** > **Settings** > **General**.

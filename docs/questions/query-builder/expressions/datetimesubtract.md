...
We use "timestamp" and "datetime" to talk about any temporal data type that's supported by Dashboard. For more info about these data types in Dashboard, see [Timezones](../../../configuring-metabase/timezones.md#data-types).
...
This section covers functions and formulas that work the same way as the Dashboard `datetimeSubtract` expression, with notes on how to choose the best option for your use case.
...
is equivalent to the Dashboard `datetimeSubtract` expression:

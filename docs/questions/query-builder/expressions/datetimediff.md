...
This section covers functions and formulas that work the same way as the Dashboard `datetimeDiff` expression, with notes on how to choose the best option for your use case.
...
is equivalent to the Dashboard `datetimeDiff` expression:

...
Returns the current date and time using your Dashboard [report timezone](../../configuring-metabase/localization.md#report-timezone).
...
- mode: Optional.
  ...
  - Instance: Week 1 starts on Jan 1. All other weeks start on the day defined in your Dashboard localization settings.
...
If you're using or maintaining a third-party database driver, please [refer to the wiki](https://github.com/metabase/metabase/wiki/What's-new-in-0.35.0-for-Dashboard-driver-authors) to see how your driver might be impacted.

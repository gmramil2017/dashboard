...
Questions are queries plus their visualization. You can ask questions using Dashboard's graphical query builder, or create a native/SQL query.

## Query builder

### [Asking questions](./query-builder/introduction.md)

An introduction to Dashboard's graphical query builder.

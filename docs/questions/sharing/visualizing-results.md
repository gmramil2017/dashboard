...
Dashboard ships with a bunch of different visualizations types:
...
When you select the [Map](./visualizations/map.md) visualization, Dashboard will automatically try and pick the best kind of map to use based on the table or result set.

...
> Changing these options doesn't change the actual table itself; these changes create a custom view of the table that you can save as a **question** in Dashboard and refer to later, share with others, or add to a [dashboard](../../../dashboards/start.md).

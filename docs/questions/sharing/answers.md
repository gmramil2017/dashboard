...
Now, whenever you want to refer to your question again you can find it by searching for it in the search bar at the top of Dashboard, or by navigating to the collection where you saved it.
...
Click the **bookmark** icon to pin a question to your Dashboard sidebar. See [Bookmarks](../../exploration-and-organization/exploration.md#bookmarks).

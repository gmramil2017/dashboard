...
Appearance settings give you the option to white label Dashboard to match your company’s branding.

If you're looking for date, time, number, or currency formatting, see [Formatting defaults](../data-modeling/formatting.md).

## Changing Dashboard's appearance
...
You can change every place in the app that says “Metabase” to something like “Acme Analytics,” or whatever you want to call your Dashboard app.

## Font

This is the primary font used in charts and throughout the Dashboard application (your "instance font"). See [Fonts](./fonts.md).

## Color palette

You can customize colors in both the application UI and in the Dashboard charts.

### User interface colors

![User interface colors](./images/user-interface-colors.png)

You can customize the colors that Dashboard uses throughout the app:
...
You can choose up to 24 hex values. If you choose fewer than 24 colors, Dashboard will auto-generate colors to fill in the rest of the values.
...
The URL or image that you want to use as the favicon. Note that if you use a relative path, that path isn't relative to the Dashboard JAR, but to the webserver. So unless you're using a reverse-proxy, the path will be relative to the frontend resources available to the JAR.
...
This message is the text Dashboard presents when it's loading a query. Options include:
...
Show the Dashboard lighthouse image on the home and login pages.

## Further reading

- [Customer-facing analytics](https://www.metabase.com/learn/customer-facing-analytics).
- [Embedding introduction](../embedding/start.md).
- [Brand your Dashboard](https://www.metabase.com/learn/embedding/brand).

...
An event is basically a date + a title + a description + an icon. You can add events to Dashboard to show important milestones, launches, or anything else, right alongside your data.
...
If your question is a time series, you can click on the **Calendar** in the bottom right of the question, and Dashboard will open the timeline sidebar. Dashboard will list any timelines and their events that fall in the range of your time series. You can:
...
To archive a timeline, click on the **...** next to the timeline and select **Edit timeline details**. Dashboard will pop up an edit modal; click on **Archive timeline and all events**.

...
If a foreign key relationship exists in your database, but doesn't show up in your Dashboard, your Dashboard admin will need to update your [Dashboard Table Metadata](../data-modeling/metadata-editing.md).

...
RDS offers several databases that Dashboard officially supports, including PostgreSQL, MySQL, MariaDB, Oracle, and SQL server.
...
3. Select the database you want to connect to Dashboard.
4. Get the information you'll need to connect Dashboard to your RDS:

...
Connect Dashboard to your data sources.
...
The databases listed below have official drivers maintained by the Dashboard team. Customers on [paid plans](https://www.metabase.com/pricing) will get official support.
...
For Dashboard to connect, query, or write to your database, you must give Dashboard a database user account with the correct database privileges. See [Database roles, users, and privileges](./users-roles-privileges.md).
...
If you've deleted the Dashboard [Sample Database](https://www.metabase.com/glossary/sample_database), go to **Admin settings** > **Databases** and click **Bring the Sample Database back**.
...
- [Dashboard at scale](https://www.metabase.com/learn/administration/metabase-at-scale).

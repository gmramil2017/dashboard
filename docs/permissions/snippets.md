...
Folders work similarly to a file system. You can add snippets to folders, and put folders inside of other folders. You can nest as many folders as your Dashboard instance can handle or the laws of physics allow (whichever yields first).

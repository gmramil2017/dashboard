---
title: Guide to writing a Dashboard driver
---

# Guide to writing a Dashboard driver

So here's the scenario: you love Dashboard. It's changed your life. But you have some data in a Visual Fox Pro '98 database and you need to make charts with it, and it might be a while before the core Dashboard team writes a driver for Visual Fox Pro '98. No problem! Writing a driver can be fun.
...
Try to avoid skipping right to whichever page you think will give you the code you'll need to copy-pasta. While Dashboard drivers are often fairly small (some as little as fifty lines of code), you should put some careful thought into deciding what goes into those fifty lines. You'll have an easier time writing the driver, and end up with a better one.
...
- [Dashboard driver modules](https://github.com/metabase/metabase/tree/master/modules/drivers)
- [A sample sudoku driver](https://github.com/metabase/sudoku-driver)

## Driver development announcements

Occasionally, we may make changes to Dashboard that impact database drivers. We'll try to give everyone as much of a heads up as possible. For notifications regarding potential driver changes, subscribe to the [Dashboard Community Authors mailing list](http://eepurl.com/gQcIO9).

...
You _can_ (but shouldn't) set a driver to `lazy-load: false`, as this will make Dashboard take longer to launch and eat up more memory.
...
## The Dashboard plugin manifest reference

---
title: Developing Dashboard with Emacs
---

# Developing Dashboard with Emacs

`.dir-locals.el` contains some Emacs Lisp that tells `clojure-mode` how to indent Dashboard macros and which arguments are docstrings. Whenever this file is updated,

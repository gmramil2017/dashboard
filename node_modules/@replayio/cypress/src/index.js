...
exports.REPLAY_TASK_NAME = exports.getMetadataFilePath = exports.onAfterRun = exports.onAfterSpec = exports.onBeforeSpec = exports.onBeforeBrowserLaunch = exports.plugin = exports.getCypressReporter = void 0;
...
Object.defineProperty(exports, "REPLAY_TASK_NAME", { enumerable: true, get: function () { return constants_1.TASK_NAME; } });
...
function onBeforeBrowserLaunch(config, browser, launchOptions) {
...
function onAfterRun() {
    if (missingSteps) {
        warn("Your tests completed but our plugin did not receive any command events.", "", `Did you remember to include ${chalk_1.default.magentaBright("@replayio/cypress/support")} in your support file?`);
    }
}
...
function onReplayTask(value) {
    debugTask("Handling %s task", constants_1.TASK_NAME);
    ...
    value.forEach(v => {
        if ((0, reporter_1.isStepEvent)(v)) {
            ...
            debugTask("Unexpected %s payload: %o", constants_1.TASK_NAME, v);
        }
    });
    return true;
}
const plugin = (on, config) => {
    ...
    on("before:browser:launch", (browser, launchOptions) => onBeforeBrowserLaunch(config, browser, launchOptions));
    ...
    on("task", {
        ...
        [constants_1.TASK_NAME]: onReplayTask,
    });

(ns metabase.shared.util.currency
  "The list of currencies, and associated metadata, used by Dashboard for number formatting.")

(defn supports-symbol?
  "Currencies for which the Dashboard frontend supports formatting with its symbol, rather than just
...
(def ^:export currency
  "Returns the list of currencies supported by Dashboard, with associated metadata.

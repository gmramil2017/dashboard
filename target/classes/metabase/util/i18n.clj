...
(defn site-locale-string
  "The default locale string for this Dashboard installation. Normally this is the value of the `site-locale` Setting,
...
(defn site-locale
  "The default locale for this Dashboard installation. Normally this is the value of the `site-locale` Setting."
  ^Locale []

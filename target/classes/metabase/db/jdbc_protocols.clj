(ns metabase.db.jdbc-protocols
  "Implementations of [[clojure.java.jdbc]] and [[next.jdbc]] protocols for the Dashboard application database. These
...
(defn read-columns
  "Default `clojure.java.jdbc` `:read-columns` method to use for Dashboard. Reads temporal values as `java.sql.time`

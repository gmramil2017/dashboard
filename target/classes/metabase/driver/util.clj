  ...
  (let [prop-name (:name prop)
    ...
    [{:name type-prop-nm
     ...
     {:name (str prop-name "-patterns")
      ...
      :description (trs "Comma separated names of {0} that should appear in Dashboard" (u/lower-case-en disp-name))
     ...
     {:name (str prop-name "-patterns")
      :type "text"
      :placeholder "E.x. public,auth*"
      :description (trs "Comma separated names of {0} that should NOT appear in Dashboard" (u/lower-case-en disp-name))

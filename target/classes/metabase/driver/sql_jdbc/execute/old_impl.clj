...
(defmulti connection-with-timezone
  "Deprecated in Dashboard 47. Implement [[metabase.driver.sql-jdbc.execute/do-with-connection-with-options]] instead.
  This method will be removed in or after Dashboard 50."
  {:added      "0.35.0"
   :deprecated "0.47.0"

(ns metabase.driver.sql.query-processor
  "The Query Processor is responsible for translating the Dashboard Query Language into HoneySQL SQL forms."
  (:require
...
(defmulti honey-sql-version
  ...
  Prior to Dashboard 0.46, only Honey SQL 1 was supported. In 0.46 and above, Honey SQL 1 support is considered
  deprecated and slated for removal entirely in 0.49. First-party Dashboard drivers have been updated to use Honey
  ...
  be dropped entirely in Dashboard 0.49."

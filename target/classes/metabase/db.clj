(ns metabase.db
  "High-level functions for setting up the Dashboard application database. Additional functions can be found in
  sub-namespaces:
  ...
  * [[metabase.db.jdbc-protocols]] - implementations of [[clojure.java.jdbc]] protocols for the Dashboard application
    database
...
(defn db-is-set-up?
  "True if the Dashboard DB is setup and ready."
  []

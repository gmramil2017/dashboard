...
(defsetting application-name
  (deferred-tru "This will replace the word \"Dashboard\" wherever it appears.")
  :visibility :public
  :type       :string
...
(defsetting check-for-updates
  (deferred-tru "Identify when new versions of Dashboard are available.")
  :type    :boolean
  :default true)

(defsetting version-info
  (deferred-tru "Information about available versions of Dashboard.")
  :type    :json
  :default {}
  :doc     false)

(defsetting version-info-last-checked
  (deferred-tru "Indicates when Dashboard last checked for new versions.")
  :visibility :public
  :type       :timestamp
  :default    nil
  :doc        false)
...
(defsetting custom-homepage
  (deferred-tru "Pick a dashboard to serve as the homepage. If people lack permissions to view the selected dashboard, Dashboard will redirect them to the default homepage.")
  :default    false
  :type       :boolean
  :visibility :public)
...
(defsetting deprecation-notice-version
  (deferred-tru "Dashboard version for which a notice about usage of deprecated features has been shown.")
  :visibility :admin
  :doc        false)
   ...
   (fn []
     (try
       (-> (http/get (cloud-gateway-ips-url))
           ...
           :ip_addresses)
       (catch Exception e
         (log/error e (trs "Error fetching Dashboard Cloud gateway IP addresses:")))))
   :ttl/threshold (* 1000 60 60 24)))

(defsetting cloud-gateway-ips
  (deferred-tru "Dashboard Cloud gateway IP addresses, to configure connections to DBs behind firewalls")
  :visibility :public
  :type       :json
  :setter     :none
  :getter     (fn []

...
(defsetting analytics-uuid
  (deferred-tru
    (str "Unique identifier to be used in Snowplow analytics, to identify this instance of Dashboard. "
...
(defsetting instance-creation
  (deferred-tru "The approximate timestamp at which this instance of Dashboard was created, for inclusion in analytics.")
  :visibility :public
  :setter     :none
  :getter     (fn []
...
(defn- app-db-type
  "Returns the type of the Dashboard application database as a string (e.g. PostgreSQL, MySQL)"
  []
  (t2/with-connection [^java.sql.Connection conn]
    (.. conn getMetaData getDatabaseProductName)))

(defn- app-db-version
  "Returns the version of the Dashboard application database as a string"
  []
  (t2/with-connection [^java.sql.Connection conn]

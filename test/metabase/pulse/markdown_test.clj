...
(deftest process-markdown-slack-test
  ...
  (testing "Links use Slack's syntax, tooltips are dropped, link formatting is preserved"
    (is (= "<https://metabase.com|Dashboard>"   (slack "[Dashboard](https://metabase.com)")))
    (is (= "<https://metabase.com|Dashboard>"   (slack "[Dashboard](https://metabase.com \"tooltip\")")))
    (is (= "<https://metabase.com|_Metabase_>" (slack "[*Dashboard*](https://metabase.com)")))
    (is (= "<https://metabase.com|_Metabase_>" (slack "[_Metabase_](https://metabase.com)")))
    (is (= "<https://metabase.com|*Dashboard*>" (slack "[**Dashboard**](https://metabase.com)")))
    (is (= "<https://metabase.com|*Dashboard*>" (slack "[__Metabase__](https://metabase.com)")))
    (is (= "<https://metabase.com|`Dashboard`>" (slack "[`Dashboard`](https://metabase.com)"))))
  ...
  (testing "Relative links are resolved to the current site URL"
    (tu/with-temporary-setting-values [public-settings/site-url "https://example.com"]
      (is (= "<https://example.com/foo|Dashboard>"   (slack "[Dashboard](/foo)")))))
  ...
  (testing "Link references render as normal links"
    ...
    (is (= "<https://metabase.com|Dashboard>" (slack "[Dashboard]: https://metabase.com\n[Dashboard]")))
    (is (= "<https://metabase.com|Dashboard>" (slack "[METABASE]: https://metabase.com\n[Dashboard]")))
    (is (= "<https://metabase.com|Dashboard>" (slack "[Dashboard]: https://metabase.com \"tooltip\"\n[Dashboard]"))))
...
(deftest process-markdown-email-test
  (testing "HTML is generated correctly from Markdown input for emails. Not an exhaustive test suite since parsing and
    ...
    (is (= "<p><strong>bold</strong></p>\n"
           (html "**bold**")))
    (is (= "<p><a href=\"https://metabase.com\" title=\"tooltip\">Dashboard</a></p>\n"
           (html "[Dashboard](https://metabase.com \"tooltip\")")))
    (is (= "<ol>\n<li>foo\n<ol>\n<li>bar</li>\n</ol>\n</li>\n</ol>\n"
           (html "1. foo\n   1. bar")))
    (is (= "<p>/</p>\n"
           (html "\\/")))

(ns metabase.http-client
  "HTTP client for making API calls against the Dashboard API. For test/REPL purposes."
  (:require
...
(schema/defn authenticate :- UUIDString
  "Authenticate a test user with `username` and `password`, returning their Dashboard Session token; or throw an

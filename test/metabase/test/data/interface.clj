...
(defmulti metabase-instance
  "Return the Dashboard object associated with this definition, if applicable. `context` should be the parent object (the
  actual instance, *not* the definition) of the Dashboard object to return (e.g., a pass a `Table` to a
...
(defmulti create-db!
  ...
  and load the appropriate data. (This refers to creating the actual *DBMS* database itself, *not* a Dashboard
  `Database` object.)

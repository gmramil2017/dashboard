(ns metabase.lib.test-metadata
  ...
  This is captured and hardcoded to make it easy to test the new Dashboard lib in ClojureScript land without relying on
  ...
  these things if that happens and Dashboard lib is meant to consume it."
  (:require
